...
# Example Usage: To view the output:
    # labs/spark-streaming/speech-feeder.py 2>/dev/null

# Example Usage: To send the output using nc:
    # labs/spark-streaming/speech-feeder.py 2>/dev/null | nc localhost 9999

# Example Usage: To view the output while also sending using nc:
    # For grabbing in the shell:
         # labs/spark-streaming/speech-feeder.py 2>/dev/null | tee | nc localhost 9999
    # For sending to spark-submit for wordcounts:
         # labs/spark-streaming/speech-feeder.py 2>/dev/null | tee | nc -lk 9999
